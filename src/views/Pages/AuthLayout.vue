        ...
        <b-row align-v="center" class="justify-content-xl-between">
          <b-col xl="6">
            <div class="copyright text-center text-xl-left text-muted">
              © {{year}} <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">Creative Tim | </a>Implementado por <a href="https://github.com/JennyVicencio" class="font-weight-bold ml-1" target="_blank"><strong>Jennyfer Vicencio</strong></a>
            </div>
          </b-col>
